...
4) Attributions:
   ...
   B) JS:  <script defer src="./js/app.js"></script>
   C) LOGO:  <link rel="Icon" href="./assets/LOGO.png">
   D) Background: background:url("../assets/background.jpg");
   E) Back-Card:  <img src="./assets/Back-Card.PNG" alt="Back card" class="back-card">
   F) CSS Image: <img src="./assets/CSS.png" alt="CSS Image" class="front-card">
   G) HTML Image: <img src="./assets/HTML.png" alt="HTML Image" class="front-card">
   H) JS Image: <img src="./assets/JS.png" alt="JavaScript Image" class="front-card">
   I) php Image: <img src="./assets/php.png" alt="php Image" class="front-card">
   J) python Image: <img src="./assets/python.png" alt="python Image" class="front-card">
   K) SQL Image: <img src="./assets/SQL.png" alt="SQL Image" class="front-card">
